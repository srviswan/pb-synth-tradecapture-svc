...
class SwapBlotterTest {
    ...
    class ConstructionTests {
        ...
        void should_IncludeContract_When_Constructed() {
            // Given
            var contract = new java.util.HashMap<String, Object>();
            contract.put("identifier", TestFixtures.createSampleSecurity());
            contract.put("economicTerms", TestFixtures.createSampleEconomicTerms());
